...
import { FaMortarPestle, FaStar } from 'react-icons/fa';
          ...
          <div>
                ...
                >
                  ...
                  >
                    ...
                    <g>
                      <g>
                        <path
                          d="M232.727,23.273V11.636C232.727,4.655,228.073,0,221.091,0c-6.982,0-11.636,4.655-11.636,11.636v46.545
			...
			c2.327,0,3.491,0,5.818-1.164c32.582-18.618,53.527-53.527,53.527-91.927V58.182C267.636,38.4,252.509,23.273,232.727,23.273z"
                    ...
                    <g>
                      <g>
                        <path
                          d="M445.673,424.727c-3.491-5.818-10.473-6.982-16.291-4.655c-5.818,3.491-6.982,10.473-4.655,16.291
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                ...
                >
                  <div>
                    <GiStethoscope size={24} color="currentColor" />
                  </div>
                  Diagnosis
                </NavLink>
              </li>
              <li>
                <NavLink
                  to="/menu/remedies"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('remedies') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <div>
                    <FaMortarPestle size={24} color="currentColor" />
                  </div>
                  Remedies
                </NavLink>
              </li>
              <li>
                <NavLink
                  to="/menu/chatbot"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('chatbot') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <BsChatDots size={24} color="currentColor" />
                  ChatBot
                </NavLink>
              </li>
              <li>
